...
use crate::GameState;
use crate::open_pack::components::*;
use crate::open_pack::observer::*;
use crate::open_pack::startup::*;
use crate::open_pack::update::*;
use crate::open_pack::ui::*;

pub struct OpenPackPlugin;

impl Plugin for OpenPackPlugin {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_systems(OnEnter(GameState::OpeningPack2), (
                reset_resources,
                spawn_camera,
                spawn_return_button,
                spawn_swipe_button,
            ...
            .chain()
            .run_if(in_state(GameState::OpeningPack2)));
    }
}
